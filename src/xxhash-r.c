...
//  xxhash
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SEXP xxhash_vec_(SEXP buffer_, SEXP algo_) {
  int sexp_type = TYPEOF(buffer_);
  int size = length(buffer_);
  unsigned char *src;

  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  // Create a generic pointer into the data, and calculate the actual
  // size of elements to be encoded i.e. number of *bytes*
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  switch(sexp_type) {
  case LGLSXP:
  case INTSXP:
    src = (unsigned char *)(INTEGER(buffer_));
    size *= 4;
    break;
  case REALSXP:
    src = (unsigned char *)(REAL(buffer_));
    size *= 8;
    break;
  case RAWSXP:
    src = (unsigned char *)(RAW(buffer_));
    break;
  case CPLXSXP:
    src = (unsigned char *)(COMPLEX(buffer_));
    size *= 16;
    break;
  default:
    error("xxhash_vec(): Unsupported SEXP type: %i\n", sexp_type);
  }
  ...
  if (strcmp(algo, "xxhash32") == 0) {
    ...
    // xxhash32
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    XXH32_hash_t hash = XXH32(src, size, 0);
  ...
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  // Wrap C character string into an R string object
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
